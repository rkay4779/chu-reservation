...
// interface Profil { id: number; libelle: string; }
// interface Service { id: number; libelle: string; }
// interface Specialite { id: number; libelle: string; service_id: number; }
...
//     e.preventDefault();
//     // ✅ Pas de route(), on cible directement l’URL POST
//     post("/admin/users", {
//       onSuccess: () => {
//         reset();
//       },
...
//           <Link
//             href="/admin/users" // ✅ Pas de route(), lien direct
//             className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 text-black dark:text-white px-4 py-2 rounded-md transition"
//           >
//             Retour à la liste
//           </Link>
//         </div>
...
//               ))}
//             </select>
//             {errors.profil_id && <p className="mt-1 text-sm text-red-600">{errors.profil_id}</p>}
//           </div>
...
//                 setData("specialite_id", ""); // reset si service change
//               }}
//               className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-black dark:text-white px-3 py-2 rounded-md"
//             >
...
//               className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-black dark:text-white px-3 py-2 rounded-md"
//               disabled={filteredSpecialites.length === 0 && !!serviceFilter}
//             >
...
//               type="button"
//               onClick={() => reset()}
//               className="bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-md transition dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white"
//               disabled={processing}
//             >
//               Réinitialiser
//             </button>
...
//               // className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-black dark:text-white px-3 py-2 rounded-md"
//               className="border border-gray-300 dark:border-gray-700 bg-white dark:bg-black text-black dark:text-white px-3 py-2 rounded-md"
//               placeholder="Entrez votre uméro de téléphone "
//             />
//             {errors.telephone && (
...
//               value={data.password}
//               onChange={(e) => setData("password", e.target.value)}
//               // className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-black dark:text-white px-3 py-2 rounded-md pr-10"
...
//               onClick={() => reset()}
//               // className="bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-md transition dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white"
//               className="bg-gray-200 hover:bg-gray-300 text-black px-4 py-2 rounded-md transition dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white"
//               disabled={processing}
//             >
//               Réinitialiser
//             </button>
...
//               disabled={processing}
//               // className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-md transition"
//               className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-md transition dark:bg-white dark:text-black dark:hover:bg-gray-200"
//             >
//               {processing ? "Enregistrement..." : "Enregistrer"}
//             </button>
//           </div>
