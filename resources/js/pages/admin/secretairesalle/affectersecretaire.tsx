...
// export default function AffecterSecretaire() {
//   const { secretaires, salles, success } = usePage<{
//     secretaires: User[]
//     salles: Salle[]
//     success?: string
...
//   const submit: FormEventHandler = (e) => {
//     e.preventDefault()
//     post('/admin/secretairesalle/affectersecretaire', {
//       onSuccess: () => reset(),
//     })
//   }
...
export default function AffecterSecretaire() {
  ...
  // ✅ État local pour message de succès qui disparaît automatiquement
    ...
    <AppLayout>
      ...
      <div className="px-6 py-10 max-w-3xl">
        <h1 className="text-2xl font-bold mb-6 dark:text-white">
          Affecter une Salle à un Secrétaire
        </h1>

        {localSuccess && (
          <div className="mb-4 rounded-lg bg-green-600 text-white px-4 py-2 text-sm font-medium transition-opacity duration-300 ease-in-out">
            ✅ {localSuccess}
          </div>
        )}
