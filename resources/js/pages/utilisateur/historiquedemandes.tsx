...
export default function HistoriqueDemandesSecretaire() {
    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-xl font-bold">Historique des demandes des salles</h1>
          <DataExport
            data={exportData}
            columns={columns}
            filename="historique_demandes_salles"
            title="Historique des demandes (secrétaire)"
          />
        </div>
